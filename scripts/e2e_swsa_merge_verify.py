...
# 박보험  : EI support==collect → adjustment=0 → 고용보험 셀 보존(P2). WEHAGO 초기값 15000 유지
...
# WEHAGO 다운로드 엑셀의 초기 고용보험값 (자동산정 시뮬레이션)
WEHAGO_EI_INITIAL = {"홍길동": 0, "김철수": 0, "박보험": 15000, "최국고": 0}

# 기대치 (최종 업로드 엑셀 셀 값)
EXPECTED = {
    # name: (건강보험, 장기요양보험료, 국민연금, 고용보험)
    "홍길동": (100000, 50000, 200000, -30000),   # EI: -|30000|
    "김철수": (80000, 40000, 160000, 20000),     # NPS: member+retro(정산col없음→누적)=160000, EI: +|20000|
    "박보험": (0, 0, 0, 15000),                  # EI adjustment=0 → 셀 보존(P2)
    "최국고": (0, 0, 80000, 0),                  # NPS: member-govt=80000
}
